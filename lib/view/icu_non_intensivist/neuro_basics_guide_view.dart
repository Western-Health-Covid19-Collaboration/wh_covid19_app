...
class NeuroBasicsView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final tabs = neuroBasicsGuide.map((e) {
    ...
    return TabViewTemplate(Strings.neuroBasicsTitle,
        color: AppColors.blue50,
        tabs: tabs,
        indicatorColor: AppColors.blue900,
        children: neuroBasicsGuide.map((e) {
          if (e is IntubationContent) {
