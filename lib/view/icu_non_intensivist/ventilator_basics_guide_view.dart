...
class VentBasicsView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final tabs = ventBasicsGuide.map((e) {
    ...
    return TabViewTemplate(Strings.ventBasicsTitle,
        color: AppColors.blue50,
        tabs: tabs,
        indicatorColor: AppColors.blue900,
        children: ventBasicsGuide.map((e) {
          if (e is IntubationContent) {
