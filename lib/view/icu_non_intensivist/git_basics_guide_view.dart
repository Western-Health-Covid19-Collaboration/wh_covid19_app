...
class GastroBasicsView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final tabs = gitBasicsGuide.map((e) {
    ...
    return TabViewTemplate(Strings.gastroBasicsTitle,
        color: AppColors.blue50,
        tabs: tabs,
        indicatorColor: AppColors.blue900,
        children: gitBasicsGuide.map((e) {
          if (e is IntubationContent) {
